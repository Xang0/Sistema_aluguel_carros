...
(data_nascimento, nome, cpf, rua, cep, cidade, bairro, status, senha, tipo) 
VALUES ('$dataCliente', '$nomeCliente', '$cpfCliente', '$ruaCliente', '$cepCliente', '$cidadeCliente', '$bairroCliente', '$statusCliente', '$senhaCliente', 'C')";
