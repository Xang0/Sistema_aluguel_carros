                    ...
                    <div id="menu">
                        ...
                        <div id="wrapperlogin">
                            <form enctype="multipart/form-data" method="POST" action="salvaFuncionario.php">
                                ...
                                <input type="text" id="dataFuncionario" maxlength="10" onkeypress="formatar_mascara(this,'####-##-##')" name="dataFuncionario" />
                                <br>
                                <br>
                                ...
                                <input type="text" id="cepFuncionario" maxlength="10" onkeypress="formatar_mascara(this,'##.###-###')" name="cepFuncionario" />
                                <br>

                                <label id="textocadastra">Rua:</label>
                                <input type="text" id="ruaFuncionario" name="ruaFuncionario" />
                                <br>

                                <label id="textocadastra">Bairro:</label>
                                <input type="text" id="bairroFuncionario" name="bairroFuncionario" />
                                <br>

                                <label id="textocadastra">Cidade:</label>
                                <input type="text" id="cidadeFuncionario" name="cidadeFuncionario" />
                                <br>

                                <label id="textocadastra">Função:</label>
                                <input type="text" id="funcaoFuncionario" name="funcaoFuncionario" />
                                <br>
