...
Este sistema foi desenvolvido como trabalho para a matéria Projeto Integrador da Universidade Federal de Lavras.

#### Grupo:

**Alexandre Moraes Pereira Carvalhaes Filho**
**Gabriel Carvalho Andrade**
...
Após a instalação do PostgreSQL, cria-se um servidor utilizando a interface do PostgreSQL. Veja na Figura 1.

OBS: A utilizada para este projeto foi o pgAdmin4.
